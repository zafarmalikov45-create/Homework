...
# natija= " ".join((lambda a: [i[::-1] for i in a]) (input().split)())
# print(natija)



# a= ["RAVSHAN", "ZAFAR", "TEMUR", "LOLA", "SUNNAT"]
# b=["SHOHRUX", "FAYOZBEK", "ABUBAKR", "LOLA", "SUNNAT"]
# c=[]
...
#         print(r[i], end="" if i == len(r)-1 else " -> ")
...
def maximum_price(son, products):
    products.sort(key=lambda x: x["price"], reverse=True)
    return products[:son]


n = int(input("Nechta mahsulot: "))
products = []
for i in range(n):
    name = input("Nomi: ")
...
son = int(input("Nechta eng qimmat kerak: "))

result = maximum_price(son, products)
